...
# No ponemos 'nohup' aquí dentro para que si lanzas este .sh con nohup
# el output se quede en el control del archivo padre.
python -u src/tfg_molecular_generation/pretrain.py \
