...
wget -q --show-progress https://ndownloader.figshare.com/files/13612760 -O data/guacamol_v1_train.smiles
echo "Descargando Valid (~80 k)..."
wget -q --show-progress https://ndownloader.figshare.com/files/13612766 -O data/guacamol_v1_valid.smiles
echo "Descargando Test (~238 k)..."
wget -q --show-progress https://ndownloader.figshare.com/files/13612757 -O data/guacamol_v1_test.smiles
